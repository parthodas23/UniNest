    ...
    <>
      {landLord !== null && (
        <div className="flex flex-col w-full">
          ...
          <textarea className="w-full text-xl text-gray-600 border-2 px-4 py-2 border-gray-300 rounded"
            name="message"
            id="message"
            rows="2"
            value={message}
          ...
          > <button className=" mt-3 cursor-pointer px-7 py-2 bg-blue-300 rounded w-full hover:bg-blue-500 shadow-md">Send Message</button></a>
        </div>
      )}
    </>
  );
